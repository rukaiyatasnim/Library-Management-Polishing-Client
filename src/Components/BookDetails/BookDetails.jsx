    ...
    return (
        <div className="max-w-2xl mx-auto my-14 px-6 py-8 bg-white border border-gray-200 rounded-2xl shadow-lg">
            ...
            <div className="space-y-3 text-sm text-gray-700">
                <p><span className="font-semibold text-blue-600">Author:</span> {book.author}</p>
                <p><span className="font-semibold text-blue-600">Category:</span> {book.category}</p>
                <p><span className="font-semibold text-blue-600">Quantity:</span> {book.quantity}</p>
                <p><span className="font-semibold text-blue-600">Rating:</span> ⭐ {book.rating} / 5</p>
                <p>
                    <span className="font-semibold text-blue-600">Short Description:</span><br />
                    {book.shortDescription}
                </p>
                <p>
                    <span className="font-semibold text-blue-600">Content:</span><br />
                    {book.content}
                </p>
            </div>

            {/* Pass the book ID in the URL params */}
